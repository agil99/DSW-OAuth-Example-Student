...
app.secret_key = os.environ['SECRET_KEY'] #use secret_key to sign in
oauth = OAuth(app)

#Set up github as the OAuth provider.
github = oauth.remote_app(
    'github',
    consumer_key=os.environ['GITHUB_CLIENT_ID'], #your webapps "username"
    consumer_secret=os.environ['GITHUB_CLIENT_SECRET'], #your webapps "password"
...
#context processors run before template are rendered and add variables to the template's context.
#context processors must return a dictionary
#Context processor adds the variable logged_in to the context for all templates.
...
def authorized():
    ...
    if resp is None:
        ...
        try:
            ...
            session.clear()
            message = 'Unable to logn. Please try again.'
